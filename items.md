...
- Perform a Challenging (+0) Ranged (Blackpowder) Test:
    - This Test is -10 in humid or windy weather and -20 in wet weather.
    - If Failed by at least 6 SLs the gun fizzles and the charge is lost.
    - Blunderbuses have the Dangeous propery: Failed Rolls are Fumbles if doubles or if the Unit Die is 9 or 10. 
